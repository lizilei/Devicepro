 ...
 * @version 1.0.0
 */
public class BhJiaoyanFragment extends BaseFragment {
    ...
    public static BhJiaoyanFragment instance = null;
    ...
    private void showToolsView(LayoutInflater inflater) {
        toolsList=new String[]{"装置基本信息","安装及运维信息","运行基本信息","通道信息","安控信息","ICD文件信息","连接器信息","CT信息","资产信息"};
    ...
    private class ShopAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int arg0) {
            ...
            bundle.putSerializable("jiaoYanData", (Serializable)JiaoYanActivity.instance.jiaoYanData.getBhData());
