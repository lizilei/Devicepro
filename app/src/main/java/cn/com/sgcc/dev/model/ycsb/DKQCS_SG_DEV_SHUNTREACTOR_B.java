...
//
///**
// * <p>@description:电抗器基本信息</p>
// * 表名：SG_DEV_SHUNTREACTOR_B
// *
// * @author lizilei
// * @version 1.0.0
...
//
//@Entity
//public class DKQCS_SG_DEV_SHUNTREACTOR_B implements Serializable {
...
//    private double CAPACITY_RATE;    // 额定容量
...
//    @Generated(hash = 1351931456)
//    public DKQCS_SG_DEV_SHUNTREACTOR_B(String ID, String RES_ID, String ED_TAG,
//            String NAME, String ST_ID, String VOLTAGE_TYPE, String BAY_ID,
//            String TYPE, String SUPPLIER_ID, String MODEL, String ASSETS_COMPANY_ID,
//            String MAINT_ORG_ID, String DISPATCH_ORG_ID, String LICENSE_ORG_ID,
//            String MONITOR_ORG_ID, double CAPACITY_RATE, float V_RATE,
...
//        this.JNODE = JNODE;
//    }
//    @Generated(hash = 1737434385)
//    public DKQCS_SG_DEV_SHUNTREACTOR_B() {
//    }
//    public String getID() {
//        return this.ID;
//    }
...
//        this.MONITOR_ORG_ID = MONITOR_ORG_ID;
//    }
//    public double getCAPACITY_RATE() {
//        return this.CAPACITY_RATE;
//    }
//    public void setCAPACITY_RATE(double CAPACITY_RATE) {
//        this.CAPACITY_RATE = CAPACITY_RATE;
//    }
