...
//import cn.com.sgcc.dev.dao.BHPZ_GG_SG_PRT_PUBLICDEVDao;
...
//import cn.com.sgcc.dev.dao2.BHPZ_GG_SG_PRT_PUBLICDEVDao;
//
///**
// * <p>@description:公用类装置</p>
// * 表名：SG_PRT_PUBLICDEV
// *
// * @author lizilei
// * @version 1.0.0
...
// * @since 2017/8/25
// */
//@Entity(nameInDb = "SG_PRT_PUBLICDEV")
//public class BHPZ_GG_SG_PRT_PUBLICDEV implements Serializable {
...
//    @Property(nameInDb = "DEVICE_USE")
//    private int DEVICE_USE;//装置用途
//    @Property(nameInDb = "FAULTRECORD_TYPE")
//    private int FAULTRECORD_TYPE;//故障录波器类型
//    @Property(nameInDb = "ANALOG_CN")
//    private int ANALOG_CN;//模拟通道数
//    @Property(nameInDb = "NUMBER_CN")
//    private int NUMBER_CN;//数字通道数
//    @Property(nameInDb = "FORM")
//    private int FORM;//测距形式
//    @Property(nameInDb = "LINE_NAME")
//    private String LINE_NAME;//测距线路
...
//    private int TYPE_REFINE;//装置类型细化
...
//    private String SOCKET_FAC;//连接器插座组件制造厂家
//    @Property(nameInDb = "SOCKET_MODEL")
//    private String SOCKET_MODEL;//连接器插座组件型号
...
//    @Generated(hash = 1856936717)
//    private transient BHPZ_GG_SG_PRT_PUBLICDEVDao myDao;
//    @Generated(hash = 1339582353)
//    public BHPZ_GG_SG_PRT_PUBLICDEV(String ID, String RES_ID, String ED_TAG,
...
//            int DEVICE_USE, int FAULTRECORD_TYPE, int ANALOG_CN, int NUMBER_CN,
//            int FORM, String LINE_NAME, String COMMENT, String STAMP, String OWNER,
//            int TYPE_REFINE, int DATA_COLLECTION, int EXPORT_MODE, String IS_LOCAL,
//            int CONNECT_NUM, String SOCKET_FAC, String SOCKET_MODEL,
//            int CHECK_STATUS, String DATA_UNIT, String RFID_FAC, String RFID_MODEL,
...
//        this.FAULTRECORD_TYPE = FAULTRECORD_TYPE;
//        this.ANALOG_CN = ANALOG_CN;
...
//    }
//    @Generated(hash = 1732774915)
//    public BHPZ_GG_SG_PRT_PUBLICDEV() {
//    }
//    public String getID() {
//        return this.ID;
//    }
...
//        this.JOB_NUMBER = JOB_NUMBER;
//    }
//    public int getDEVICE_USE() {
//        return this.DEVICE_USE;
//    }
//    public void setDEVICE_USE(int DEVICE_USE) {
//        this.DEVICE_USE = DEVICE_USE;
//    }
//    public int getFAULTRECORD_TYPE() {
//        return this.FAULTRECORD_TYPE;
//    }
//    public void setFAULTRECORD_TYPE(int FAULTRECORD_TYPE) {
//        this.FAULTRECORD_TYPE = FAULTRECORD_TYPE;
//    }
//    public int getANALOG_CN() {
//        return this.ANALOG_CN;
//    }
//    public void setANALOG_CN(int ANALOG_CN) {
//        this.ANALOG_CN = ANALOG_CN;
//    }
//    public int getNUMBER_CN() {
//        return this.NUMBER_CN;
//    }
//    public void setNUMBER_CN(int NUMBER_CN) {
//        this.NUMBER_CN = NUMBER_CN;
//    }
//    public int getFORM() {
//        return this.FORM;
...
//                    ._queryBHPZ_GG_SG_PRT_PUBLICDEV_Bkxxs(ID);
//            synchronized (this) {
//                if (bkxxs == null) {
//                    bkxxs = bkxxsNew;
//                }
...
//                    ._queryBHPZ_GG_SG_PRT_PUBLICDEV_Icdxxs(ID);
//            synchronized (this) {
//                if (icdxxs == null) {
//                    icdxxs = icdxxsNew;
//                }
...
//                    ._queryBHPZ_GG_SG_PRT_PUBLICDEV_Ljqxxs(ID);
//            synchronized (this) {
//                if (ljqxxs == null) {
//                    ljqxxs = ljqxxsNew;
//                }
...
//                    ._queryBHPZ_GG_SG_PRT_PUBLICDEV_Tdxxs(ID);
//            synchronized (this) {
//                if (tdxxs == null) {
//                    tdxxs = tdxxsNew;
//                }
...
//                    ._queryBHPZ_GG_SG_PRT_PUBLICDEV_Rjbbs(ID);
//            synchronized (this) {
//                if (rjbbs == null) {
//                    rjbbs = rjbbsNew;
//                }
...
//    }
//    /** called by internal mechanisms, do not call yourself. */
//    @Generated(hash = 980070227)
//    public void __setDaoSession(DaoSession daoSession) {
//        this.daoSession = daoSession;
//        myDao = daoSession != null ? daoSession.getBHPZ_GG_SG_PRT_PUBLICDEVDao() : null;
//    }
//}
