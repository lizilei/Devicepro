...
@Entity(nameInDb = "FDJCS", createInDb = false)
public class FDJCS {
    ...
    @Generated(hash = 157322189)
    public FDJCS(Long id, String BH, String FDJMC, String CZMC, int DYDJ,
            String KGBH, String SFTCYX, String BZ, String sh, String shr2,
            String shyy, String GLDW, int vf, int WDID, String dddw, String czr,
            String tjr, String dwtjr, String jglx, String jgmc, Date CZSJ,
