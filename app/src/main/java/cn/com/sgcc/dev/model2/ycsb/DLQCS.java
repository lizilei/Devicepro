...
@Entity(nameInDb = "DLQCS", createInDb = false)
public class DLQCS {
    ...
    // @ZdhzColumn(columnName = "DLQMC")
    // @ExcelField(name = "断路器名称", next = "DYDJ")
    @Property(nameInDb = "DLQMC")
    private String DLQMC;   // 断路器名称

    // @ZdhzColumn(columnName = "CZMC")
    // @ExcelField(name = "厂站名称", next = "DLQMC")
    ...
    @Generated(hash = 1651599662)
    public DLQCS(int vf, Long id, String BH, String DLQMC, String CZMC, String KGBH,
            int DYDJ, String SFTCYX, String BZ, String sh, String shr2, String shyy,
            String GLDW, String czr, String tjr, String dwtjr, int WDID,
            String dddw, String jglx, String jgmc, Date CZSJ, String SFBDSJ,
    ...
    public String getDLQMC() {
        return this.DLQMC;
    }
    public void setDLQMC(String DLQMC) {
        this.DLQMC = DLQMC;
    }
