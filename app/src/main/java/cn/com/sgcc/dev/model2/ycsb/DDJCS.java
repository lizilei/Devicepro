...
@Entity(nameInDb = "DDJCS", createInDb = false)
public class DDJCS {
    ...
    private int id;      // 电动机ID
    // @ZdhzColumn(columnName = "BH")
    // @ExcelField(name = "编号", next = "GLDW")
    @Property(nameInDb = "BH")
    private String BH;      // 编号
    // @ZdhzColumn(columnName = "DDJMC")
    // @ExcelField(name = "电动机名称", next = "DYDJ")
    @Property(nameInDb = "DDJMC")
    private String DDJMC;   // 电动机名称
    // @ZdhzColumn(columnName = "CZMC")
    // @ExcelField(name = "厂站名称", next = "DDJMC")
    ...
    @Generated(hash = 66137546)
    public DDJCS(int vf, int id, String BH, String DDJMC, String CZMC, int DYDJ,
            String SFTCYX, String BZ, String sh, String shr2, String shyy,
            String GLDW, String KGBH, int WDID, String dddw, String czr, String tjr,
