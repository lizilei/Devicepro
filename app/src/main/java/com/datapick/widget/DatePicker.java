...
import com.datapick.widget.genview.WheelGeneralAdapter;
import com.datapick.widget.view.WheelView;
...
class DatePicker extends BaseWheelPick {
    ...
    public void init() {
        ...
        this.secondView = (WheelView) findViewById(R.id.second);
        ...
        secondArr = datePicker.gensecond();
        ...
        setWheelListener(secondView, secondArr, true);
        ...
        secondView.setCurrentItem(datePicker.findIndextByValue(datePicker.getToady(DatePickerHelper.Type.second), secondArr));
    ...
    protected String[] convertData(WheelView wheelView, Integer[] data) {
        ...
        }else if (wheelView == secondView) {
            return datePicker.getDisplayValue(data, "秒");
        }
        return new String[0];
    }
    ...
    public void onChanged(WheelView wheel, int oldValue, int newValue) {
        ...
        int second = secondArr[secondView.getCurrentItem()];
        ...
        if (onChangeLisener != null) {
            onChangeLisener.onChanged(DateUtils.getDate(year, moth, day, hour, minut,second));
        }
    ...
    public Date getSelectDate() {
        ...
        return DateUtils.getDate(year, moth, day, hour, minut,second);
