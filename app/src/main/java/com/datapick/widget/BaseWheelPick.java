...
import com.datapick.widget.adapters.WheelViewAdapter;
import com.datapick.widget.genview.GenWheelText;
import com.datapick.widget.genview.WheelGeneralAdapter;
import com.datapick.widget.view.OnWheelChangedListener;
import com.datapick.widget.view.OnWheelScrollListener;
 ...
 */
 abstract class BaseWheelPick
    ...
    protected void setWheelListener(WheelView wheelView, Object[] data, boolean isCyclic) {
        ...
        wheelView.setViewAdapter((WheelViewAdapter) viewAdapter);
